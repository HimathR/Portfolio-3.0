  ...
  return (
    ...
    >
      <div className="flex-1">
        <h1 className="text-4xl sm:text-6xl mt-0 mb-2 sm:mb-4 bg-clip-text text-transparent bg-gradient-to-r from-red-500 via-blue-500 to-pink-500">
          {"< Hello! / >"}
        </h1>
        ...
        <h1 className="text-3xl sm:text-4xl mt-0 mb-2 sm:mb-4 leading-snug font-normal text-purple-700">
          {"Software Developer"}
        </h1>
